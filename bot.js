...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Creativity Community'];
    var i = -1;
    var j = 0;
...
const b = commands.Bot(-=`NTUwMjkwNTAzNzYyMDUxMDky.D1gR6w.2jfpn6BNNgI3HYOyRkpWf_uZMX8`)
...
const bot.run(`NTUwMjkwNTAzNzYyMDUxMDky.D1gR6w.2jfpn6BNNgI3HYOyRkpWf_uZMX8`)
